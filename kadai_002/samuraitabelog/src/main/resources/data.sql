...
-- restaurantsテーブル
INSERT IGNORE INTO restaurants (id, name, image_name, description, category_id, opening_time, closing_time, lowest_price, highest_price, number_of_seats, postal_code, address, phone_number) VALUES (1, '焼き鳥 SAMURAI', 'restaurant01.jpg', '最寄り駅から徒歩10分。風味豊かで新鮮な地元の食材を使用しています。宴会の予約も受け付けております。', 1, '16:00:00', '22:00:00', 2000, 4000, 35, '073-0145', '北海道砂川市西五条南X-XX-XX', '012-345-678');
...
INSERT IGNORE INTO users (id, name, furigana, gender_id, occupation_id, plan_type_id, postal_code, address, phone_number, email, password, role_id, enabled) VALUES (3, '侍 義勝', 'サムライ ヨシカツ', '1', '1', '1', '638-0644', '奈良県五條市西吉野町湯川X-XX-XX', '090-1234-5678', 'yoshikatsu.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true);
